...
@Data
@NoArgsConstructor
public class CalendarJournal extends AbstractCalMapper {

    @DynamoDBAttribute(attributeName = "CalendarUid")
    private String calendarUid;

    @DynamoDBAttribute(attributeName = "JournalUid")
    private String journalUid;
